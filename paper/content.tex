...
The official website of ClouStack recommends a set of best priactices for ease of 
mainainance and installation. Its advised that a full scale producion deployment 
can take 4-8 weeks, so the deployment to be planned accordingly for possible 
fallabacks and troubleshooting.  For security evenry machine should be allowed contact 
with limited resources and in a secure SSL channel. RAM and disk storage uasge monitoring 
is the key to promote high availability. Regular apllication of hotfixes are also necsaary for 
seamless operation.
