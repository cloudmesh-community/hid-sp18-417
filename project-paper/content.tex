...
\end{verbatim}
  ...
  handling them. A demonstration of the replication manager and the cleanup
...
\begin{figure}[htb]
	\centering\includegraphics[width=\columnwidth]{images/hid_417_localhost_benchmark.png}
...
The default kubernetes/flask-web-ui.yml in the git repo defines 3 replicas.
...
\begin{figure}[htb]
  ...
  \caption{Benchmark}\label{fig:project_benchmark}
 \end{figure}

 A short video was recorded provisidng the overview of the
